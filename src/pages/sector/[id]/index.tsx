...
import SectorCreate from '@/components/sector/sector-create'
import { useRouter } from 'next/router'
import { useSectorPutdQuery } from '@/data/analytics'
...
export default function CreateUser() {
  ...
  const { sector, loading, error } = useSectorPutdQuery({
    //@ts-ignore
    id: id,
  })
    ...
    <>
      {permission ? (
        <>
          ...
          <SectorCreate initialValues={sector} />
        </>
      ) : (
        <DontView />
      )}
