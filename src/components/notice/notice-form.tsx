...
import { noticeSchema } from './notice-schema-validation'
...
export default function CreateOrUpdateNoticeForm({ initialValues }: Props) {
  ...
  return (
    <>
      {enviroments && enviroments.length < 1 ? (
        <WarningCompoenent
          text="Es necesario crear un ambiente"
          route="environments"
        />
      ) : null}
          ...
          <Card className="w-full sm:w-8/12 md:w-2/3">
            ...
            <div className="mb-4 flex flex-col sm:flex-row">
              <div className="mb-5 w-full p-0 sm:mb-0 sm:w-1/2 sm:pe-2">
                ...
                />
                <ValidationError
                  message={errors.effectiveFrom?.message ?? ''}
                />
              </div>
