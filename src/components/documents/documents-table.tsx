...
const DocumentypeTable = ({ data }: any) => {
  ...
  const columns: any = [
    ...
    },
    {
      ...
      key: 'name',
      align: 'center' as AlignType,
      render: (value: string) => <span>{capitalizeWords(value)}</span>,
    },
    {
      title: 'Acciones',
      ...
      render: (id: any, record: any) => (
        <>
          <ActionButtons
            id={id}
            editUrl={Routes.documents.edit({ id })}
            deleteModalView={'DELETE_TYPEDOCUMENT'}
          />
        </>
      ),
    },
...
export default DocumentypeTable
