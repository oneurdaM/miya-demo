export const selectStyles = {
  option: (provided: any, state: any) => ({
    ...provided,
    fontSize: '0.875rem',
    color: state.isDisabled ? '#B0B0B0' : '#6B7280', // Color de texto para opciones deshabilitadas
    paddingLeft: 16,
    paddingRight: 16,
    paddingTop: 12,
    paddingBottom: 12,
    cursor: state.isDisabled ? 'not-allowed' : 'pointer', // Cambia el cursor para opciones deshabilitadas
    backgroundColor: state.isDisabled
      ? '#F5F5F5' // Color de fondo para opciones deshabilitadas
      : state.isSelected
      ? '#E5E7EB' // Color de fondo para opciones seleccionadas
      : state.isFocused
      ? '#F9FAFB' // Color de fondo para opciones enfocadas
      : '#ffffff', // Color de fondo por defecto
  }),
